...
ALTER TABLE public.temp_artifact_metadata
ADD COLUMN gcs_path text null,
ADD COLUMN internal_reference_number text null,
ADD COLUMN hand_present boolean null,
ADD COLUMN short_description text null,
ADD COLUMN long_description text null,
ADD COLUMN misc_information text null,
ADD COLUMN ai_generated boolean null;

CREATE OR REPLACE FUNCTION insert_llm_artifact_metadata_with_timestamp(
    image_id_input TEXT,
    gcs_path_input TEXT,
    ...
    misc_information_input TEXT,
    ai_generated_input BOOLEAN,
    created_at_input TIMESTAMPTZ DEFAULT NULL -- Added this parameter
)
RETURNS UUID AS $$
DECLARE
...
BEGIN
    INSERT INTO temp_artifact_metadata (
        ...
        misc_information_input,
        COALESCE(ai_generated_input, TRUE),
